...
void front()
{
	...
	output(300,650,"SJC INSTITUTE OF TECHNOLOGY ",fonts[2]);
	glColor3f(1.0,1.0,0.0);
	...
	output(250,350,"1] ML Soumika(1SJ20CS075)",fonts[2]);
	output(650,350,"2] Mayuri S(1SJ20CS085)",fonts[2]);
...
void help()
{
	...
	glColor3f(0.5,0.2,0.6);
	output(600,60,"[ Dept. of CSE, SJCIT]",fonts[0]);
}
void intro()
{
	glColor3f(0.8,0.1,0.2);
